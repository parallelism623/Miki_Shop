        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefreshTk = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__PRODUCT__CATEGOR__2CF2ADDF",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Order_detail", x => new { x.ProductId, x.OrderId });
                    table.ForeignKey(
                        name: "FK__ORDER_DET__ORDER__32AB8735",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__ORDER_DET__PRODU__3587F3E0",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: true),
                    Index = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__PRODUCT___C5B100083B40F9CD", x => x.Url);
                    table.ForeignKey(
                        name: "FK__PRODUCT_I__PRODU__395884C4",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__PRODUCT___9420F6C487A5BC55", x => new { x.ProductId, x.SizeId });
                    table.ForeignKey(
                        name: "FK__PRODUCT_S__PRODU__3D2915A8",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK__PRODUCT_S__SIZE___3E1D39E1",
                        column: x => x.SizeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSizeDetail_SizeId",
                table: "ProductSizeDetail",
                column: "SizeId");
        }
